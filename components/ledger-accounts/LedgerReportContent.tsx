...
export default function LedgerReportContent({
 ...
 return (
 <div className="ledger-report-content border rounded-lg p-4 bg-background text-sm space-y-2">
 <div className="text-center">
 <p className="font-semibold text-base">Sheel Waterproofing</p>
 ...
 <TableCell colSpan={5} className="text-right font-medium tabular-nums">
 Total
 </TableCell>
 ...
 <TableRow className="font-semibold border-t-2 border-b-4 border-double">
 ...
 <p className="font-semibold text-navy dark:text-navy">
 ...
 {report && showLedgerBody && (
 <div className="rounded-lg border bg-muted dark:bg-muted p-3">
