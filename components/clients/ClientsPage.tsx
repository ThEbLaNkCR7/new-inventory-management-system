    ...
    <div className="space-y-4 min-h-screen transition-colors duration-300">
      ...
      <div className="relative">
        <div className="space-y-2">
          ...
          <p className="page-desc">Manage client relationships and contact information</p>
        </div>
        ...
        <DialogContent className="max-w-md">
          <div className="text-center py-4">
            ...
            <DialogDescription className="text-center text-muted-foreground mb-4">
              Are you sure you want to delete <span className="font-semibold text-navy">{deletingClient?.name}</span>? This action cannot be undone.
              {!isAdmin && (
                    ...
                    <TableCell>
                      <div className="space-y-1">
                        <div className="flex items-center text-sm">
                          ...
                          <span className="text-navy">{client.email}</span>
                        </div>
                        <div className="flex items-center text-sm">
                          <Phone className="h-4 w-4 mr-2 text-muted-foreground" />
                          <span className="text-navy">{client.phone}</span>
                        </div>
                      </div>
                    </TableCell>
                    <TableCell>
